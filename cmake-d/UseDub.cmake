...
if (CMAKE_CROSSCOMPILING)
    # todo: change this
    set(CMAKE_D_COMPILER_NATIVE gdc)
else()
    set(CMAKE_D_COMPILER_NATIVE ${CMAKE_D_COMPILER})
endif()

if(NOT CMAKE_D_COMPILER_NATIVE)
...
if(NOT EXISTS ${DUB_DIRECTORY}/CMakeTmp/DubUrl)
	...
	execute_process(COMMAND ${CMAKE_D_COMPILER_NATIVE} -I${SEMVER_PATH} ${DUB_GET_PACKAGE_URL_D_SRC} ${SEMVER_SRC}
...
if(NOT EXISTS ${DUB_DIRECTORY}/CMakeTmp/DubToCMake)
	find_file(DUB_PACKAGE_TO_CMAKE_D_SRC "DubToCMake.d"
		PATHS ${CMAKE_ROOT}/Modules ${CMAKE_MODULE_PATH} NO_DEFAULT_PATH
		PATH_SUFFIXES "UseDub")
	execute_process(COMMAND ${CMAKE_D_COMPILER_NATIVE} ${DUB_PACKAGE_TO_CMAKE_D_SRC} ${CMAKE_D_DASH_O}DubToCMake
